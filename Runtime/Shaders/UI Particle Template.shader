Shader /*ase_name*/"Hidden/UI/Particle"/*end*/
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            v2f vert(appdata_t v /*ase_vert_input*/)
            {
                ...
                OUT.customData = /*ase_vert_out:Custom Data;Float4*/ float4( 0, 0, 0, 0) /*end*/;
                v.vertex.xyz = /*ase_vert_out:Vertex Position;Float3*/ float3( 0, 0, 0 ) /*end*/;
